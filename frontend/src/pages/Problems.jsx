...
export default function Problems() {
  ...
  async function onEditTestCase(updatedTestCase) {
  try {
    // Call API to update test case
    const updatedProblem = await updateTestCase(
      testCaseProblem._id,
      updatedTestCase._id,
      updatedTestCase
    );

    // Update modal state & problem list state with updated data
    setTestCaseProblem(updatedProblem);
    setProblems(prevProblems =>
      prevProblems.map(p => (p._id === updatedProblem._id ? updatedProblem : p))
    );
